...
const ShowItem = ({
  ...
  // this could be done with state, but I don't want to introduce state here
  ...
  return (
    <div className="table-row">
      ...
      <div className="table-cell">{genres.replace(/\b\w/g, l => l.toUpperCase())}</div>
      <div className="table-cell">{status.replace(/\b\w/g, l => l.toUpperCase())}</div>
        ...
        {poster === 'Image not found' ? (
          ...
          <div className="image">
            ...
            <div className="modal" ref={modal}>
              <span onClick={onCrossClick} className="close">
                &times;
              </span>
              <img
                onClick={onImgClick}
      ...
      {watchers ? <div className="table-cell">{watchers}</div> : null}
      <div className="table-cell">
        {renderDescription()}
        {description !== null ? (
          description.length > 350 && (
            <p className="read-more" onClick={onDescriptionClick}>
